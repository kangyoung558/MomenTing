...
<jsp:include page="../includes/sidebar.jsp" />
	...
	<div class="main-container">
		...
		<!-- <div class="col-sm-12 col-md-6">
			<div class="card card-box mb-4 postCard"id="postCard">
		     	<div class="board-content">
					<div class="card-header py-3">
						<i class="boardPopover icon-copy fa fa-ellipsis-h cursor-pointer float-right" aria-hidden="true" data-toggle="popover" id="boardpopover"></i>
						...
						<ul class="list-group list-group-flush chat">
							<li class="list-group mb-2">
								<div class="bg-mygray radius p-2">
									...
									<i class="replyPopover icon-copy fa fa-ellipsis-h cursor-pointer" aria-hidden="true" data-toggle="popover" ></i>
									<p>댓글내용 댓글내용</p>
								</div>
							</li>
							<li class="list-group mb-2">
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				boardDIV.on("click", '.replyPopover',function(){
					...
					console.log($(this).parent().closest(".replyLi"));
					console.log($(this).parent().closest(".replyLi").data("rno"));
				...
				var btnShowMore = $("#btnShowMore");
			 	function showList(bno) {
			 		//목록 호출
					boardService.getListMyBoard({bno:bno, writer:writer, cp:cp}, function(result) {
						var list = result;
						console.log(result);
						...
						console.log("${principal.vo.userName}");
						var str ="";
						for(var i in list) {
			 	...
			 	boardDIV.on("click", ".reModBtn", function() {
			 		...
			 		//alert("hi");
			 		//console.log(rno);
			 		var reply = {cp:cp, rno: rno, reply:$(this).parent().prev().children(".replyValue").val(), replyer:replyer}
